...
<div class="form-group">
    ...
    <input type="text" class="form-control-file {{$errors->has('last_name') ? 'is-invalid' : ''}}" name="last_name"
           id="last_name" placeholder="Enter last name" value="{{old('last_name') ?? $employee->last_name}}">
</div>
